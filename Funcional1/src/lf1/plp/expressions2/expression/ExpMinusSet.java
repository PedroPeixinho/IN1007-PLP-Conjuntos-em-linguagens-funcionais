...
public class ExpMinusSet implements Expressao {

    private Expressao exp1;
    private Expressao exp2;

    public ExpMinusSet(Expressao exp1, Expressao exp2) {
        this.exp1 = exp1;
        this.exp2 = exp2;
    }
    ...
    public Valor avaliar(AmbienteExecucao amb) {
        ...
        resultado.removeAll(set2.valor());
    ...
    public Expressao clone() {
        return new ExpMinusSet(exp1, exp2);
    }
}